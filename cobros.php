...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['accion'] ?? '') === 'eliminar_gasto') {
  ...
  // Ventana de "hoy" (misma lógica que usamos para listados)
  try {
...
<body class="bg-light">
            ...
            <table class="table table-sm table-striped">
              ...
              <tbody>
                <?php if (empty($gastos_hoy)): ?>
                  <tr>
                  <tr>
                    <td colspan="5" class="text-muted text-center">Sin gastos capturados hoy.</td>
                  </tr>
                  </tr>
  ...
  <script>
    (function() {
      ...
      function comisionEspecial(m) {
        return (m === "Abono PayJoy" || m === "Abono Krediya") ? 10 : 0;
      }
