...
$grpVentas = array_merge(
  ...
  [
    ...
    'payjoy_tc_nueva.php',
    'venta_accesorios.php'           // ✅ NUEVO
  ]
);

$grpInvLog     = ['inventario_global.php', 'inventario_historico.php'];
$grpInv        = array_merge($grpInvLog, ['panel.php', 'inventario_subdistribuidor.php', 'inventario_resumen.php', 'inventario_central.php', 'inventario_retiros.php', 'inventario_sims_resumen.php']);
...
<style>
  ...
  .navbar.pretty .nav-link.active, .navbar.pretty .dropdown-item.active { color: #fff !important; font-weight: 600; }
  ...
  .dropdown-menu-dark .dropdown-item { border-radius: 10px; color: var(--nb-text); font-size: var(--nb-font-drop); line-height: 1.15; padding: .35rem .65rem; }
  .dropdown-menu-dark .dropdown-item:hover { background: var(--nb-hover); color: #fff; }
  .dropdown-menu-dark .dropdown-header { color: var(--nb-muted); font-size: var(--nb-font-head); letter-spacing: .4px; text-transform: uppercase; padding: .25rem .65rem; }
  .dropdown-divider { border-top-color: var(--nb-border) !important; }

  .nav-avatar, .nav-initials {
    width: 34px; height: 34px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center;
    font-weight: 800; font-size: .9rem; color: #fff; position: relative; box-shadow: 0 0 0 2px rgba(255, 255, 255, .15);
  }
  ...
  .dropdown-avatar, .dropdown-initials {
    ...
    background: #64748b; color: #fff; font-weight: 800; font-size: 1.05rem; box-shadow: 0 0 0 3px rgba(255, 255, 255, .12);
  }
...
<nav class="navbar navbar-expand-lg navbar-dark sticky-top shadow pretty">
  <div class="container-fluid">
    ...
    <a class="navbar-brand d-flex align-items-center" href="dashboard_unificado.php">
      <img src="https://i.ibb.co/mVbYDr5L/Dise-o-sin-t-tulo-1.png"
        alt="Logo"
        width="36"
        height="36"
    ...
    <div class="collapse navbar-collapse" id="navbarMain">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-dark">
            <?php if ($rolUsuario === 'Logistica'): ?>
              ...
              <li><a class="dropdown-item<?= isActive(['historial_payjoy_tc.php']) ?>" href="historial_payjoy_tc.php"><i class="bi bi-credit-card-2-front me-2"></i>Historial TDC PayJoy</a></li>
              <li><a class="dropdown-item<?= isActive(['historial_ventas_accesorios.php']) ?>" href="historial_ventas_accesorios.php"><i class="bi bi-headphones me-2"></i>Historial accesorios</a></li>
            <?php else: ?>
              <!-- Ventas nuevas -->
              ...
              <?php endif; ?>
              <li><a class="dropdown-item<?= isActive(['payjoy_tc_nueva.php']) ?>" href="payjoy_tc_nueva.php"><i class="bi bi-credit-card me-2"></i>Venta TDC PayJoy</a></li>
              <li><a class="dropdown-item<?= isActive(['venta_accesorios.php']) ?>" href="venta_accesorios.php"><i class="bi bi-headphones me-2"></i>Venta accesorios</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-dark">
            <?php if ($rolUsuario === 'Logistica'): ?>
              ...
              <li><a class="dropdown-item<?= isActive(['inventario_sims_resumen.php']) ?>" href="inventario_sims_resumen.php"><i class="bi bi-sim me-2"></i>Inventario SIMs</a></li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
              <?php if (in_array($rolUsuario, ['Admin', 'Super'])): ?>
                ...
                <li><a class="dropdown-item<?= isActive(['traspaso_directo_ma.php']) ?>" href="traspaso_directo_ma.php"><i class="bi bi-sign-turn-right me-2"></i>Traspaso directo MA</a></li>
              <?php endif; ?>
        ...
        <!-- EFECTIVO -->
        <?php if ($rolUsuario === 'Admin'): ?>
          <!-- Admin: SOLO Validar depósitos -->
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle<?= parentActive(['depositos.php']) ?>" href="#" role="button" data-bs-toggle="dropdown">
        ...
        <!-- OPERACIÓN -->
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle<?= parentActive($grpOperacion) ?>" href="#" role="button" data-bs-toggle="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-dark">
            <?php if ($rolUsuario === 'Logistica'): ?>
              ...
              <li><a class="dropdown-item<?= isActive(['panel_operador.php']) ?>" href="panel_operador.php"><i class="bi bi-broadcast-pin me-2"></i>Panel Operador</a></li>
            <?php else: ?>
              <li><a class="dropdown-item<?= isActive(['lista_precios.php']) ?>" href="lista_precios.php"><i class="bi bi-tag me-2"></i>Lista de precios</a></li>

              <?php if (in_array($rolUsuario, ['Admin'])): ?>
                <li><a class="dropdown-item<?= isActive(['panel_operador.php']) ?>" href="panel_operador.php"><i class="bi bi-broadcast-pin me-2"></i>Panel Operador</a></li>
              <?php endif; ?>
              ...
              <?php if (in_array($rolUsuario, ['Gerente', 'Admin', 'GerenteZona'])): ?>
                <li><a class="dropdown-item<?= isActive(['gestionar_usuarios.php']) ?>" href="gestionar_usuarios.php"><i class="bi bi-people me-2"></i>Gestionar usuarios</a></li>
              <?php endif; ?>
